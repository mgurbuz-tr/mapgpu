...
export class DistanceUnit {
    private static readonly FEET_PER_METER: number = 3.28084;
    private static readonly FLIGHT_LEVEL_PER_METER: number = 0.0328084; // hundreds of feet
    public readonly conversionFactor: number = 0;
    public readonly label: string;

    public constructor(conversionFactor: number, label: string) {
    ...
    public static parse(distanceUnitText: string): DistanceUnit | null {
        ...
        let conversionFactor: number = parseFloat(parts[0].trim());
