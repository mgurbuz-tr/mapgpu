...
export class SVGTextInfo {
	...
	protected _aboveBaseHeight: number = 0;
	...
	public constructor(text: string, x: number, y: number, font: Font, context: OffscreenCanvasRenderingContext2D | CanvasRenderingContext2D | null);
	public constructor(text: string, x: number, y: number, font: string, context: OffscreenCanvasRenderingContext2D | CanvasRenderingContext2D | null);
	public constructor(text: string, x: number, y: number, fontName: string, fontSize:number, fontStyle:string, context: OffscreenCanvasRenderingContext2D | CanvasRenderingContext2D | null);
	...
	public getTextOutlineBounds(): Rectangle2D {
		...
		let outlineOffset: number = RS.getTextOutlineWidth();
