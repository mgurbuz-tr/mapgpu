...
import { MultipointUtils } from "../multipoint/multipoint-utils";
...
export class PatternFillRenderer {
    ...
    public static MakeHatchPatternFill(hatchStyle: number, spacing: number, strokeWidth: number, color: Color): SVGSymbolInfo {
        ...
        if (hatchStyle == MultipointUtils.Hatch_ForwardDiagonal) {
            ...
            x2 = -strokeWidth;
        } else if (hatchStyle == MultipointUtils.Hatch_BackwardDiagonal) {
            x1 = -strokeWidth;
    ...
    public static MakeMetocPatternFill(tg: TacticalGraphic): SVGSymbolInfo {
