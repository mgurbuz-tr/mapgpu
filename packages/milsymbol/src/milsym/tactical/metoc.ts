 ...
 */
export class METOC {
    private static readonly _className: string = "METOC";
    public static getWeatherLinetype(version: number, entityCode: number): number {
        switch (entityCode) {
            case 110301: {
     ...
     */
    public static IsWeather(symbolID: string): number {
        //the MeTOCs
        try {
            if (symbolID == null) {
            ...
            if (exc instanceof Error) {
                //TacticalUtils.WriteFile("Error in METOC.IsWeather");
                ErrorLogger.LogException(METOC._className, "isWeather",
                    exc);
            } else {
                throw exc;
            }
        ...
        try {
            ...
            switch (tg.lineType) {   //255:150:150                    
                ...
                case TacticalLines.TROUGH: {
                    tg.lineStyle = 1;
                    tg.lineColor = Color.BLACK;
                    tg.lineCap = BasicStroke.CAP_ROUND;
                    break;
                }
                ...
                case TacticalLines.BOTTOM_TYPE_A1: {
                    tg.lineColor = new Color(48, 255, 0);   // green
                    tg.fillColor = new Color(48, 255, 0);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_A2: {
                    tg.lineColor = new Color(127, 255, 0);   //light green
                    tg.fillColor = new Color(127, 255, 0);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_C2: {
                    tg.lineColor = new Color(255, 80, 0);   //dark orange
                    tg.fillColor = new Color(255, 80, 0);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_C3: {
                    tg.lineColor = new Color(255, 48, 0);   //orange red
                    tg.fillColor = new Color(255, 48, 0);
                    break;
                }

                case TacticalLines.IMPACT_BURIAL_0: {
                    tg.lineColor = new Color(0, 0, 255);   //blue
                    tg.fillColor = new Color(0, 0, 255);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_C1:
                case TacticalLines.IMPACT_BURIAL_75: {
                    tg.lineColor = new Color(255, 127, 0);   //orange
                    tg.fillColor = new Color(255, 127, 0);
                    break;
                }
                ...
                case TacticalLines.BOTTOM_ROUGHNESS_ROUGH: {
                    tg.lineColor = new Color(255, 0, 0);   //red
                    tg.fillColor = new Color(255, 0, 0);
                    break;
                }
                ...
                case TacticalLines.BOTTOM_ROUGHNESS_MODERATE: {
                    tg.lineColor = new Color(255, 255, 0);   //yellow
                    tg.fillColor = new Color(255, 255, 0);
                    break;
                }
                ...
                case TacticalLines.BOTTOM_ROUGHNESS_SMOOTH: {
                    tg.lineColor = new Color(0, 255, 0);   //green
                    tg.fillColor = new Color(0, 255, 0);
                    break;
                }

                case TacticalLines.BOTTOM_SEDIMENTS_NO_DATA: {
                    tg.lineColor = new Color(230, 230, 230);   //light gray
                    tg.fillColor = new Color(230, 230, 230);
                    break;
                }

                case TacticalLines.BOTTOM_SEDIMENTS_LAND: {
                    tg.lineColor = new Color(220, 220, 220);   //gray
                    tg.fillColor = new Color(220, 220, 220);
                    break;
                }

                case TacticalLines.SAND_AND_SHELLS: {
                    tg.lineColor = new Color(255, 220, 220);   //light peach
                    tg.fillColor = new Color(255, 220, 220);
                    break;
                }

                case TacticalLines.PEBBLES: {
                    tg.lineColor = new Color(255, 190, 190);   //peach
                    tg.fillColor = new Color(255, 190, 190);
                    break;
                }

                case TacticalLines.OYSTER_SHELLS: {
                    tg.lineColor = new Color(255, 150, 150);   //dark peach
                    tg.fillColor = new Color(255, 150, 150);
                    break;
                }

                case TacticalLines.BOULDERS: {
                    tg.lineColor = new Color(255, 0, 0);
                    tg.fillColor = new Color(255, 0, 0);
                    break;
                }

                case TacticalLines.COARSE_SILT: {
                    tg.lineColor = new Color(200, 255, 105);
                    tg.fillColor = new Color(200, 255, 105);
                    break;
                }
                ...
                case TacticalLines.FINE_SILT: {
                    tg.lineColor = new Color(25, 255, 230);     //turquoise
                    tg.fillColor = new Color(25, 255, 230);
                    break;
                }

                case TacticalLines.VERY_FINE_SILT: {
                    tg.lineColor = new Color(0, 215, 255);     //turquoise
                    tg.fillColor = new Color(0, 215, 255);
                    break;
                }

                case TacticalLines.VERY_FINE_SAND: {
                    tg.lineColor = new Color(255, 255, 220);     //pale yellow
                    tg.fillColor = new Color(255, 255, 220);
                    break;
                }

                case TacticalLines.FINE_SAND: {
                    tg.lineColor = new Color(255, 255, 140);     //light yellow
                    tg.fillColor = new Color(255, 255, 140);
                    break;
                }

                case TacticalLines.MEDIUM_SAND: {
                    tg.lineColor = new Color(255, 235, 0);     //yellow
                    tg.fillColor = new Color(255, 235, 0);
                    break;
                }

                case TacticalLines.COARSE_SAND: {
                    tg.lineColor = new Color(255, 215, 0);     //light gold
                    tg.fillColor = new Color(255, 215, 0);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_B3: {
                    tg.lineColor = new Color(255, 207, 0);     //gold
                    tg.fillColor = new Color(255, 207, 0);
                    break;
                }

                case TacticalLines.VERY_COARSE_SAND: {
                    tg.lineColor = new Color(255, 180, 0);     //gold
                    tg.fillColor = new Color(255, 180, 0);
                    break;
                }

                case TacticalLines.CLAY: {
                    tg.lineColor = new Color(100, 130, 255);     //periwinkle
                    tg.fillColor = new Color(100, 130, 255);
                    break;
                }

                case TacticalLines.SOLID_ROCK: {
                    //tg.lineColor = new Color(160, 32, 240);     //purple
                    //tg.fillColor = new Color(160, 32, 240);
                    tg.lineColor = new Color(255, 0, 255);     //magenta
                    tg.fillColor = new Color(255, 0, 255);
                    break;
                }

                case TacticalLines.VDR_LEVEL_12: {
                    tg.lineColor = new Color(26, 153, 77);     //dark green
                    tg.fillColor = new Color(26, 153, 77);
                    break;
                }

                case TacticalLines.VDR_LEVEL_23: {
                    tg.lineColor = new Color(26, 204, 77);     //light green
                    tg.fillColor = new Color(26, 204, 77);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_A3: {
                    tg.lineColor = new Color(175, 255, 0);    //lime green
                    tg.fillColor = new Color(175, 255, 0);
                    break;
                }

                case TacticalLines.VDR_LEVEL_34: {
                    tg.lineColor = new Color(128, 255, 51);    //lime green
                    tg.fillColor = new Color(128, 255, 51);
                    break;
                }

                case TacticalLines.BOTTOM_TYPE_B1: {
                    tg.lineColor = new Color(207, 255, 0);    //yellow green
                    tg.fillColor = new Color(207, 255, 0);
                    break;
                }

                case TacticalLines.VDR_LEVEL_45: {
                    tg.lineColor = new Color(204, 255, 26);    //yellow green
                    tg.fillColor = new Color(204, 255, 26);
                    break;
                }
                ...
                case TacticalLines.VDR_LEVEL_67: {
                    tg.lineColor = new Color(255, 204, 0);     //gold
                    tg.fillColor = new Color(255, 204, 0);
                    break;
                }

                case TacticalLines.VDR_LEVEL_78: {
                    tg.lineColor = new Color(255, 128, 0);     //light orange
                    tg.fillColor = new Color(255, 128, 0);
                    break;
                }

                case TacticalLines.VDR_LEVEL_89: {
                    tg.lineColor = new Color(255, 77, 0);      //dark orange
                    tg.fillColor = new Color(255, 77, 0);
                    break;
                }

                case TacticalLines.VDR_LEVEL_910: {
                    tg.lineColor = Color.RED;
                    tg.fillColor = Color.RED;
                    break;
                }

                case TacticalLines.CANAL: {
                    tg.lineColor = Color.BLACK;
                    tg.lineThickness = 2 * tg.lineThickness; // Thick line
                    break;
                }

                case TacticalLines.OPERATOR_DEFINED: {
                    tg.lineColor = new Color(255, 128, 0);
                    break;
                }

                case TacticalLines.MARITIME_LIMIT:
                case TacticalLines.MARITIME_AREA: {
                    tg.lineColor = Color.MAGENTA;
                    tg.lineStyle = 1;
                    break;
                }
                ...
                case TacticalLines.UNDERWATER_HAZARD: {
                    tg.lineColor = Color.BLACK;
                    tg.lineStyle = 2;
                    tg.fillColor = new Color(0, 191, 255); //deep sky blue
                    break;
                }

                case TacticalLines.LOADING_FACILITY_AREA: {
                    tg.lineColor = new Color(210, 180, 140);
                    tg.fillColor = new Color(210, 180, 140);
                    break;
                }

                case TacticalLines.LOADING_FACILITY_LINE: {
                    tg.lineColor = Color.GRAY;
                    tg.lineThickness = 2 * tg.lineThickness; // Thick line
                    break;
                }
                ...
                case TacticalLines.DRYDOCK: {
                    tg.lineColor = Color.BLACK;
                    //tg.fillColor = new Color(165, 42, 42); //brown
                    tg.fillColor = new Color(205, 133, 63); //brown
                    tg.lineStyle = 1;
                    break;
                }

                case TacticalLines.FORESHORE_AREA: {
                    //tg.lineColor = new Color(154, 205, 50);
                    //tg.fillColor = new Color(154, 205, 50);
                    tg.lineColor = new Color(173, 255, 47);
                    tg.fillColor = new Color(173, 255, 47);
                    break;
                }
                ...
                case TacticalLines.ANCHORAGE_AREA: {
                    tg.lineColor = Color.MAGENTA;
                    //tg.lineStyle = 1;    //dashed
                    break;
                }

                case TacticalLines.PIPE: {
                    tg.lineColor = Color.GRAY;
                    tg.fillColor = Color.GRAY;
                    break;
                }

                case TacticalLines.WATER: {
                    tg.lineColor = Color.WHITE;
                    tg.fillColor = Color.WHITE;
                    break;
                }

                case TacticalLines.FISH_TRAPS: {
                    tg.lineColor = new Color(192, 192, 192);
                    tg.lineStyle = 1;
                    break;
                }
                ...
                case TacticalLines.BEACH: {
                    tg.lineColor = new Color(206, 158, 140);
                    tg.fillColor = new Color(206, 158, 140, Math.trunc(255 * 0.12));
                    break;
                }

                case TacticalLines.DEPTH_AREA: {
                    tg.lineColor = Color.BLUE;
                    tg.fillColor = Color.WHITE;
                    break;
                }
                ...
                case TacticalLines.OCCLUDED: {
                    tg.lineColor = new Color(160, 32, 240);
                    tg.fillColor = new Color(160, 32, 240);
                    break;
                }
                ...
                case TacticalLines.TURBULENCE: {
                    ...
                    tg.lineStyle = 2;
                    tg.lineCap = BasicStroke.CAP_ROUND;
                    let minThickness: number = Math.max(rendererSettings.getDeviceDPI() / 96, 1) * 6;
                    if (tg.lineThickness < minThickness) {

                        tg.lineThickness = minThickness;
                    }
                ...
                case TacticalLines.ISLAND: {
                    //tg.lineColor = new Color(165, 42, 42); //brown
                    //tg.fillColor = new Color(165, 42, 42); //brown
                    tg.lineColor = new Color(210, 180, 140); //tan
                    tg.fillColor = new Color(210, 180, 140); //tan
                    break;
                }
                ...
                case TacticalLines.BEACH_SLOPE_FLAT: {
                    tg.lineColor = new Color(179, 179, 179);
                    tg.fillColor = null;
                    break;
                }
                ...
                case TacticalLines.BEACH_SLOPE_STEEP: {
                    tg.lineColor = new Color(128, 128, 128);
                    tg.fillColor = null;
                    break;
                }
                ...
                case TacticalLines.SAND: {
                    tg.lineColor = new Color(165, 121, 82); //brown
                    break;
                }

                case TacticalLines.ICING: {
                    tg.lineColor = new Color(189, 154, 56); //brown
                    break;
                }
            ...
            if (exc instanceof Error) {
                //TacticalUtils.WriteFile("Error in METOC.SetMeTOCProperties");
                ErrorLogger.LogException(METOC._className, "SetMeTOCProperties",
                    exc);
            } else {
                throw exc;
            }
    ...
    private static ExtrapolatePointFromCurve(splinePoints: Array<POINT2>,
        pt: POINT2, theta: number): POINT2 | null {
        try {
            ...
            let xp: number = pt.x * cosTheta + pt.y * sinTheta;

            //if we find a pair which straddle xp then extrapolate the y value from the curve and
            //return the point
            for (let j: number = 0; j < splinePoints.length - 1; j++) {
                let x1p: number = splinePoints[j].x * cosTheta + splinePoints[j].y * sinTheta;
                let x2p: number = splinePoints[j + 1].x * cosTheta + splinePoints[j + 1].y * sinTheta;
                if ((x1p <= xp && x2p >= xp) || (x1p >= xp && x2p <= xp)) {
                    let y1p: number = -splinePoints[j].x * sinTheta + splinePoints[j].y * cosTheta;
                    let y2p: number = -splinePoints[j + 1].x * sinTheta + splinePoints[j + 1].y * cosTheta;

                    let mp: number = (y2p - y1p) / (x2p - x1p); // slope
                    let yp: number = y1p + (xp - x1p) * mp;

                    // Rotate back to normal coordinates
                    let x: number = xp * cosTheta - yp * sinTheta;
                    let y: number = xp * sinTheta + yp * cosTheta;
                    return new POINT2(x, y);
                }
            }
        } catch (exc) {
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "ExtrapolatePointFromCurve",
                    exc);
            } else {
                throw exc;
            }
     ...
     */
    public static GetMeTOCShape(tg: TacticalGraphic,
        ...
        try {
            ...
            switch (tg.lineType) {
                ...
                case TacticalLines.JET_GE:
                case TacticalLines.STREAM_GE: {
                    lineObject2 = METOC.DrawSplines(tg, splinePoints);
                ...
                case TacticalLines.ICE_OPENINGS_LEAD: {
                    ...
                    partitions = ChannelUtils.GetPartitions2(tg);
                    v = partitions.length;
                    ...
                    for (l = 0; l < v; l++) {
                        ...
                        twoSplines = METOC.ParallelLines2(pixels, arraysupport.getScaledSize(20, tg.lineThickness, tg.patternScale) as number);
                ...
                case TacticalLines.ICE_OPENINGS_FROZEN_GE: {
                    ...
                    for (l = 0; l < t; l++) {
                        ...
                        tg.Pixels = lowerSpline;
                        if (tg.lineType === TacticalLines.ICE_OPENINGS_FROZEN) {
                            lineObject2 = METOC.DrawSplines(tg, splinePoints);
                        } else {
                            let splinePoints3: Array<POINT2> = new Array();
                            lineObject2 = METOC.DrawSplines(tg, splinePoints3);
                        ...
                        tg.Pixels = upperSpline;
                        if (tg.lineType === TacticalLines.ICE_OPENINGS_FROZEN) {
                            lineObject2 = METOC.DrawSplines(tg, splinePoints2);
                        } else {
                            let splinePoints4: Array<POINT2> = new Array();
                            lineObject2 = METOC.DrawSplines(tg, splinePoints4);
                        ...
                        for (j = 0; j < splinePointsArrays.length; j++) {
                            ...
                            for (k = 0; k < array.length; k++) {
                                ...
                                let pt2: POINT2 = METOC.ExtrapolatePointFromCurve(array2, pt, theta);
                ...
                case TacticalLines.LEADING_LINE: {
                    //the solid line
                    lineObject = METOC.DrawSplines(tg, splinePoints);
                    ...
                    let n: number = splinePoints.length / 2;
                    for (j = 1; j <= n; j++) {
            ...
            //add the last point
            if (tg.lineType !== TacticalLines.ICE_OPENINGS_LEAD &&
                tg.lineType !== TacticalLines.ICE_OPENINGS_LEAD_GE &&
                tg.lineType !== TacticalLines.ICE_OPENINGS_FROZEN &&
                tg.lineType !== TacticalLines.ICE_OPENINGS_FROZEN_GE &&
                tg.lineType !== TacticalLines.ICE_EDGE_RADAR) {
            ...
            METOC.SetShapeProperties(tg, shapes);
        } catch (exc) {
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "GetMeTOCShape",
                    exc);
            } else {
                throw exc;
            }
     ...
     */
    protected static async SetShapeProperties(tg: TacticalGraphic, shapes: Array<Shape2>): Promise<void> {
        try {
            if (shapes == null) {
                return;
            }
            ...
            for (j = 0; j < n; j++) {
                ...
                if (isClosedPolygon || shapeType === Shape2.SHAPE_TYPE_FILL) {
                    switch (tg.lineType)//these have fill instead of TexturePaint
                    {
                        case TacticalLines.FORESHORE_AREA:
                        case TacticalLines.WATER:
                        case TacticalLines.BEACH:
                ...
                if (lineType === TacticalLines.INSTABILITY || lineType === TacticalLines.SHEAR) {
                    ...
                    let spacing: number = lineThickness * 2;

                    let points: Array<POINT2> = shape.getPoints();

                    let arcLength: number = 0;
                    for (let i: number = 0; i < 6; i++) { // 6 segments in each arc
                        arcLength += LineUtility.calcDistance(points[i], points[i + 1]) as number;
                    }
                    ...
                    if (lineType === TacticalLines.INSTABILITY) {
                        let dotAndSpaceLength: number = dotLength * 2 + spacing * 3;
                        let dashLength: number = (arcLength - dotAndSpaceLength) / 2;
                        dash = [dashLength, spacing, dotLength, spacing, dotLength, spacing, dashLength, 0];
                    } else { // SHEAR
                        let dotAndSpaceLength: number = dotLength + spacing * 2;
                        let dashLength: number = (arcLength - dotAndSpaceLength) / 2;
                    ...
                    if (lineType === TacticalLines.TROUGH) {
                        ...
                        let dashLength: number = 2 * lineThickness; // from TacticalUtils.getLineStroke

                        dashLength = Math.min(dashLength, arcLength / 4);

                        let dash: number[] = [dashLength, dashLength];
                        stroke = new BasicStroke(lineThickness, tg.lineCap, BasicStroke.JOIN_ROUND, 4, dash, 0);
                    } else {
                        stroke = TacticalUtils.getLineStroke(lineThickness, shape.style, tg.lineCap, BasicStroke.JOIN_ROUND);
                    }
                }
            ...
            if (exc instanceof Error) {
                //TacticalUtils.WriteFile("error in METOC.SetShapeProperties");
                ErrorLogger.LogException(METOC._className, "SetShapeProperties",
                    exc);
            } else {
                throw exc;
            }
    ...
    private static DrawArrow(pt1: POINT2,
        ...
        try {
            ...
            ptBase = LineUtility.extendAlongLine(pt2, pt1, size);
            ...
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "DrawArrow",
                    exc);
            } else {
                throw exc;
            }
     ...
     * @return
     */
    private static DrawSplines(tg: TacticalGraphic,
        ...
        try {
            ...
            let array: Array<POINT2> = tg.Pixels;
            ...
            let tension: number = 0.33;
            let control_scale: number = (tension / 0.5 * 0.175);
            let d: number = 0;
            ...
            for (i = 0; i < n - 1; i++) //was length-1
            {
                ...
                tmpArray = METOC.drawCubicBezier2(tg, lineObject, pt, p2, p3, pt2);
                ...
                switch (tg.lineType) {
                    case TacticalLines.EBB_TIDE: {
                        if (i === array.length - 2) {
                            if (splinePoints.length >= 2) {
                                ...
                                METOC.DrawArrow(splinePoints[splinePoints.length - 2], tg.Pixels[tg.Pixels.length - 1], arraysupport.getScaledSize(10, tg.lineThickness, tg.patternScale), lineObject);
                            }
                    ...
                    case TacticalLines.FLOOD_TIDE: {
                        d = arraysupport.getScaledSize(10, tg.lineThickness, tg.patternScale);
                        ...
                        if (i === array.length - 2) {
                            if (splinePoints.length >= 2) {
                                ...
                                METOC.DrawArrow(splinePoints[splinePoints.length - 2], tg.Pixels[tg.Pixels.length - 1], d, lineObject);
                            }
                    ...
                    case TacticalLines.JET: {
                        if (splinePoints.length > i + 1) {
                            METOC.DrawArrow(splinePoints[i + 1], splinePoints[i], arraysupport.getScaledSize(10, tg.lineThickness, tg.patternScale), lineObject);
                        }
                        break;
                    }
                    ...
                    case TacticalLines.FLOOD_TIDE_GE: {
                        ...
                        {
                            lineObject.moveTo(splinePoints2[0].x as number, splinePoints2[0].y as number);
                            t = splinePoints2.length;
                            //for(j=1;j<splinePoints2.length;j++)
                            for (j = 1; j < t; j++) {

                                lineObject.lineTo(splinePoints2[j].x as number, splinePoints2[j].y as number);
                            }
                    ...
                    case TacticalLines.ICE_EDGE_RADAR: {
                        ...
                        d = arraysupport.getScaledSize(5, tg.lineThickness, tg.patternScale);
            ...
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "DrawSplines",
                    exc);
            } else {
                throw exc;
            }
     ...
     */
    private static getPointOnSegment(P0: POINT2, P1: POINT2, ratio: number): POINT2 {
        ...
        try {
            ...
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "getPointOnSegment",
                    exc);
            } else {
                throw exc;
            }
    ...
    private static drawCubicBezier2(
        ...
        try {
            ...
            let PA: POINT2 = METOC.getPointOnSegment(P0, P1, 0.75);
            let PB: POINT2 = METOC.getPointOnSegment(P3, P2, 0.75);
            ...
            let Pc_1: POINT2 = METOC.getPointOnSegment(P0, P1, 0.375);

            // calculates control point 2
            let Pc_2: POINT2 = METOC.getPointOnSegment(PA, PB, 0.375);
            Pc_2.x -= dx;
            Pc_2.y -= dy;

            // calculates control point 3
            let Pc_3: POINT2 = METOC.getPointOnSegment(PB, PA, 0.375);
            Pc_3.x += dx;
            Pc_3.y += dy;

            // calculates control point 4
            let Pc_4: POINT2 = METOC.getPointOnSegment(P3, P2, 0.375);

            // calculates the 3 anchor points
            let Pa_1: POINT2 = LineUtility.midPoint(Pc_1, Pc_2, 0);
            let Pa_2: POINT2 = LineUtility.midPoint(PA, PB, 0);
            let Pa_3: POINT2 = LineUtility.midPoint(Pc_3, Pc_4, 0);
            switch (tg.lineType) {   //draw the solid curve for these
                case TacticalLines.ISOBAR:
                case TacticalLines.UPPER_AIR:
                case TacticalLines.ISODROSOTHERM:
                case TacticalLines.ICE_EDGE:
            ...
            //distance=TacticalUtils.Distance2(P0,Pa_1);
            //add the curve points to tg.Pixels
            switch (tg.lineType) {
                case TacticalLines.ICE_EDGE_RADAR:
                case TacticalLines.ICE_EDGE_RADAR_GE: {
                    increment = arraysupport.getScaledSize(20, tg.lineThickness, tg.patternScale);
                    break;
                }
                ...
                case TacticalLines.CRACKS_SPECIFIC_LOCATION_GE: {
                    //increment = 12.0;
                    increment = arraysupport.getScaledSize(7, tg.lineThickness, tg.patternScale);
                    break;
                }

                default: {
                    increment = arraysupport.getScaledSize(10, tg.lineThickness, tg.patternScale);
                    break;
                }

            }

            distance = LineUtility.calcDistance(P0, Pa_1);
            ...
            pt2 = Pa_1;
            for (j = 0; j < n; j++) {
                t = j as number * (increment / distance);
            ...
            //distance=TacticalUtils.Distance2(Pa_1,Pa_2);
            distance = LineUtility.calcDistance(Pa_1, Pa_2);
            ...
            //distance=TacticalUtils.Distance2(Pa_2,Pa_3);
            distance = LineUtility.calcDistance(Pa_2, Pa_3);
            //add the curve points to tg.Pixels
            n = Math.trunc(distance / increment);
            pt0 = Pa_2;
            pt1 = Pc_3;
            ...
            //distance=TacticalUtils.Distance2(Pa_3,P3);
            distance = LineUtility.calcDistance(Pa_3, P3);
            //add the curve points to tg.Pixels
            n = Math.trunc(distance / increment);
            pt0 = Pa_3;
            pt1 = Pc_4;
            ...
            if (exc instanceof Error) {
                ErrorLogger.LogException(METOC._className, "drawCubicBezier2",
                    exc);
            } else {
                throw exc;
            }
     ...
     */
    //    private static ArrayList ParallelLines(TacticalGraphic tg,int rev) {
     ...
     * @return
     */
    private static ParallelLines2(Pixels: Array<POINT2>, channelWidth: number): Array<POINT2> {
