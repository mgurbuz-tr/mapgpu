...
export class Shape3DHandler {
        ...
        format: number): string//,
    {
        ...
        try {
            ...
            if (msLookup.getMSLInfo(symbolCode).getDrawRule() === DrawRules.CORRIDOR1) {
            ...
            if (format === WebRenderer.OUTPUT_FORMAT_KML) {
                ...
                jsonOutput = Shape3DHandler.KMLize(id, name, description, symbolCode, shapes, modifiers, ipc, normalize, textColor, altitudeMode, mSymbol.getWasClipped());
        ...
        for (let i: number = 0; i < len; i++) {
            ...
            if (lineColor != null && fillColor == null) {
                ...
                for (let j: number = 0; j < n; j++) {
                    ...
                    let altitude: number = coord.getZ();
