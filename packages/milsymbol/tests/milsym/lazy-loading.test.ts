...
import { SVGLookup } from '../../src/milsym/renderer/utilities/SVGLookup';
import { DataLoader } from '../../src/milsym/renderer/utilities/DataLoader';
...
describe('Chunk splitting verification', () => {
  it('should have generated chunk files', async () => {
    ...
    const commonD = await import('../../src/milsym/data/2525d/svg/common.json');
  ...
  it('should have SS10 SVG chunk with correct structure', async () => {
    const ss10 = await import('../../src/milsym/data/2525d/svg/ss10.json');
  ...
  it('should have SS10 MS chunk with correct structure', async () => {
    const ss10 = await import('../../src/milsym/data/2525d/ms/ss10.json');
    const data = ss10.default || ss10;
  ...
  it('monolithic and chunked data should have same total counts', async () => {
    // Load manifest
    const manifest = await import('../../src/milsym/data/manifest.json');
    const m = manifest.default || manifest;

    // Original data
    const svgdOrig = await import('../../src/milsym/data/svgd.json');
