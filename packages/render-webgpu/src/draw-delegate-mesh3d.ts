...
import type { Mesh3DRenderBuffer, Mesh3DSymbol } from '@mapgpu/core';
...
export class DrawDelegateMesh3D {
  ...
  private _materials = new Map<string, { buffer: GPUBuffer; bindGroup: GPUBindGroup }>();
  private _globeMaterials = new Map<string, { buffer: GPUBuffer; bindGroup: GPUBindGroup }>();
