...
import type { LosAnalysisResult, IView, WidgetPosition } from '@mapgpu/core';
...
export class LOSWidget extends WidgetBase {
  ...
  private _runHandlers = new Set<(params: LOSObserverTarget) => void>();
  ...
  private _pickHandlers = new Set<() => void>();
