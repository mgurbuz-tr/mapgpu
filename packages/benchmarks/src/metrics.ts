...
export function displayMetrics(m: Partial<BenchMetrics>): void {
  ...
  el.innerHTML = `
    ...
    <tr><td colspan="2" style="padding-top:8px;text-align:right">
      <a href="results.html" style="color:#8ec5fc;font-size:0.8rem">📊 View all results →</a>
    </td></tr>
  `;
}

/**
 * Measure average FPS over `durationMs` milliseconds.
 */
