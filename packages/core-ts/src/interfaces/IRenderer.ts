...
import type { PointSymbol, LineSymbol, PolygonSymbol, ModelSymbol, ExtrudedPolygonSymbol } from './IRenderEngine.js';
 ...
 * ```
 */
export type Symbol = PointSymbol | LineSymbol | PolygonSymbol | ModelSymbol | ExtrudedPolygonSymbol;
...
export interface IRenderer {
   ...
   * @example
   * ```ts
   * const sym = renderer.getSymbol(feature, { zoom: 10, resolution: 152.87 });
   * if (sym) {
