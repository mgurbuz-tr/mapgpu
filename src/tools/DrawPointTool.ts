...
import type { ToolPointerEvent, ToolContext, Feature } from '../core/index.js';
...
export class DrawPointTool extends ToolBase {
  ...
  private readonly _snapEngine: SnapEngine | null;
  private _lastSnap: SnapResult | null = null;
  private readonly _cursorPreviewId = generatePreviewId('cursor-point');
  ...
  onPointerMove(e: ToolPointerEvent): boolean {
    if (this._state === 'active' && e.mapCoords && this._context) {
