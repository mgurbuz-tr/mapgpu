...
export class ClusterLayer extends LayerBase implements IQueryableLayer {
  ...
  private readonly _clusterMinPoints: number;
  private readonly _fields: Partial<AggregationFields>;
   ...
   */
  getClusters(extent: Extent, _zoom: number): ClusterFeature[] { // NOSONAR
