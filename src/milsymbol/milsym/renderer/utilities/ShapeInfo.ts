...
import { MilStdSymbol } from "./MilStdSymbol"
...
export class ShapeInfo {
    ...
    public static SHAPE_TYPE_POLYLINE: number = 0;
    //public static int SHAPE_TYPE_POLYGON=1;
    public static SHAPE_TYPE_FILL: number = 1;
    public static SHAPE_TYPE_MODIFIER: number = 2;
    public static SHAPE_TYPE_MODIFIER_FILL: number = 3;
    public static SHAPE_TYPE_UNIT_FRAME: number = 4;
    public static SHAPE_TYPE_UNIT_FILL: number = 5;
    public static SHAPE_TYPE_UNIT_SYMBOL1: number = 6;
    public static SHAPE_TYPE_UNIT_SYMBOL2: number = 7;
    public static SHAPE_TYPE_UNIT_DISPLAY_MODIFIER: number = 8;
    public static SHAPE_TYPE_UNIT_ECHELON: number = 9;
    public static SHAPE_TYPE_UNIT_AFFILIATION_MODIFIER: number = 10;
    public static SHAPE_TYPE_UNIT_HQ_STAFF: number = 11;
    public static SHAPE_TYPE_TG_SP_FILL: number = 12;
    public static SHAPE_TYPE_TG_SP_FRAME: number = 13;
    public static SHAPE_TYPE_TG_Q_MODIFIER: number = 14;
    public static SHAPE_TYPE_TG_SP_OUTLINE: number = 15;
    public static SHAPE_TYPE_SINGLE_POINT_OUTLINE: number = 16;
    public static SHAPE_TYPE_UNIT_OUTLINE: number = 17;
    public static SHAPE_TYPE_UNIT_OPERATIONAL_CONDITION: number = 18;

    public static justify_left: number = 0;
    public static justify_center: number = 1;
    public static justify_right: number = 2;


    protected _Shape: Shape = null;
    private stroke: BasicStroke = null;
    private gp: GeneralPath = null;
    private fillStyle: number = 0;
    /**
     * @deprecated
     */
    ...
    private _ModifierAngle: number = 0;
    ...
    private _justify: number = ShapeInfo.justify_left;
    //for google earth
     ...
     */
    constructor(shape: Shape, shapeType: number);
        ...
        switch (args.length) {
            ...
            case 2: {
                if (args[0] instanceof TextLayout) {
                    ...
                    const [shape, shapeType] = args as [Shape, number];
                    this._Shape = shape;
    ...
    public setModifierAngle(value: number): void {
        this._ModifierAngle = value;
    }

    public getModifierAngle(): number {
     ...
     */
    public setModifierStringAngle(value: number): void {
     ...
     */
    public getModifierStringAngle(): number {
...
public Rectangle getBounds()
{
   ...
   if(_Shape != null)
       ...
       return _GlyphVector.getPixelBounds(null, (number)_Position.getX(), (number)_Position.getY());
   else if(_TextLayout != null && _Position != null)
   {
       temp = _TextLayout.getPixelBounds(null, (number)_Position.getX(), (number)_Position.getY());
       return temp;
   }
   else if(_TextLayout != null)//for deutch multipoint labels
   {
    ...
    public getBounds(): Rectangle | null {
        ...
        if (this._Shape != null) {
                ...
                if (this._ShapeType === ShapeInfo.SHAPE_TYPE_UNIT_OUTLINE) {
                    if (this.lineColor != null && this.stroke != null) {
                        if (this.stroke != null && this.stroke.getLineWidth() > 2) {
                            ...
                            temp.grow(this.stroke.getLineWidth() as number / 2, this.stroke.getLineWidth() as number / 2);
                        }
                    ...
                    if (this.lineColor != null && this.stroke != null) {
                        if (this.stroke != null && this.stroke.getLineWidth() > 2) {
                            ...
                            temp.grow(this.stroke.getLineWidth() as number - 1, this.stroke.getLineWidth() as number - 1);
                        }
            ...
            //       temp = this._GlyphVector.getPixelBounds(null, this._Position.getX() as number, this._Position.getY() as number);
            //   }
            //else {
            if (this._TextLayout != null && this._Position != null) {
                temp = this._TextLayout.getPixelBounds(null, this._Position.getX() as number, this._Position.getY() as number);
    ...
    public getFillStyle(): number {
        return this.fillStyle;
    }
    public setFillStyle(value: number): void {
     ...
     *
     */
    public setShapeType(value: number): void {
    ...
    public getTextJustify(): number {
        return this._justify;
    }

    public setTextJustify(value: number): void {
        this._justify = value;
    }
}
