...
import type { FeaturePickResult } from '../core/index.js';
  ...
  async pick(x: number, y: number): Promise<FeaturePickResult | null> {
    ...
    const pickPass = encoder.beginRenderPass({
      ...
      depthStencilAttachment: {
        ...
        // Reverse-Z (compareFunc='greater') → clearValue=0; standart Z → 1.
        // Main depth buffer ile tutarlı olması için depthConfig'ten okunur.
