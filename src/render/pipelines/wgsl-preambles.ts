...
// Reverse-Z globe depth ordering:
//   sphere point kameraya tangent plane'in \u00f6n\u00fcnde (yak\u0131n)  \u2192 dot+w  \u2248 1-planeD  \u2265 0
//   sphere point horizon'da                                  \u2192 dot+w  = 0
//   sphere point k\u00fcre arkas\u0131nda                             \u2192 dot+w  < 0  (clipped)
// 3D mode reverse-Z (compareFunc='greater', clearValue=0) ile uyumlu:
// yak\u0131n objeler y\u00fcksek NDC z, horizon=0, arkas\u0131 negatif (hardware clip'lenir).
