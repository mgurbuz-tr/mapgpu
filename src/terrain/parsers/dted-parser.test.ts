...
describe('dted-parser', () => {
  ...
  it('extracts coordinates from canonical file names', () => {
    ...
    // Lat-first flat: n39e032.dt2
    expect(extractCoordsFromFilename('n39e032.dt2')).toEqual([32, 39]);
    // Lon-first flat: e032n39.dt2
    expect(extractCoordsFromFilename('e026n38.dt1')).toEqual([26, 38]);
    expect(extractCoordsFromFilename('E032N39.dt2')).toEqual([32, 39]);
    expect(extractCoordsFromFilename('w120s07.dt0')).toEqual([-120, -7]);
  });
