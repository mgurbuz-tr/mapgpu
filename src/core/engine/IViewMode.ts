...
import type { CameraState, IRenderEngine, ResolvedGlobeEffects } from '../interfaces/index.js';
...
export interface RenderFrameContext {
   ...
   *
   * @see {@link ResolvedGlobeEffects}
   */
  readonly globeEffects: ResolvedGlobeEffects;
}
