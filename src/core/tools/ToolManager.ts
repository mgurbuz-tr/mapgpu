...
export class ToolManager {
  ...
  private readonly _events = new EventBus<ToolEvents>();
  private readonly _commands: CommandSystem;
  private _previewLayer: IPreviewLayer | null = null;
  private readonly _wheelPassthrough: boolean;
  ...
  private readonly _dblClickThreshold = 300; // ms
  private readonly _dblClickDistance = 5; // px
  ...
  private _ensureOverlay(): void {
    ...
    overlay.dataset.mapgpuToolOverlay = 'true';
